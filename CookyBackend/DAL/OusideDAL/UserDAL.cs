...
namespace CookyBackend.DAL.OusideDAL
{
    public class UserDAL
    {
        ...
        public ReturnResult<User> GetUserById(int id)
        {
            ...
            try
            {
                provider.SetQuery("Users_GetById", CommandType.StoredProcedure)
        ...
        public ReturnResult<User> ActiveUser(User user)
        {
            ...
            {
                db = new DbProvider();
                db.SetQuery("User_Change_Status", CommandType.StoredProcedure);
                db.SetParameter("UserId", SqlDbType.Int, user.Id)
                .SetParameter("StatusPayment", SqlDbType.Int, user.StatusPayment)
                .SetParameter("ErrorCode", SqlDbType.NVarChar, DBNull.Value, 100, ParameterDirection.Output)
                .SetParameter("ErrorMessage", SqlDbType.NVarChar, DBNull.Value, 4000, ParameterDirection.Output)
                .ExcuteNonQuery()
